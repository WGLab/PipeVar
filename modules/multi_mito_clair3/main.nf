// Batch mitochondrial SNP/indel calling with Clair3 for long-read alignments.
process multi_mito_clair3 {
	...
	output:
	tuple val(out_prefix), path("${out_prefix}.mito.clair3.raw.vcf.gz")
