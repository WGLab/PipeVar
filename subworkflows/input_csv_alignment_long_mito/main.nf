...
include { multi_mito_clair3_postprocess } from '../../modules/multi_mito_clair3_postprocess/'
...
workflow INPUT_CSV_ALIGNMENT_LONG_MITO {
	...
	raw_mt_vcf = multi_mito_clair3(input_bam_with_bam, ref_fa, mito_contig)
	mt_vcf = multi_mito_clair3_postprocess(raw_mt_vcf)
